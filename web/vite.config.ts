...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Create Canary e2e-create-mslza814-9xruzh-test",
        short_name: "Create Canary e2e-create-mslza814-9xruzh-test",
        description: "Create Canary e2e-create-mslza814-9xruzh-test — free forever",
        start_url: "/",
        display: "standalone",
